import { Dimensions, StyleSheet, Text, View, Image, Pressable, ScrollView, FlatList } from 'react-native'
    ...
    <ScrollView showsVerticalScrollIndicator={false}>
      <View style={styles.container}>
        ...
        <View style={styles.headerContainer}>
          <Image style={styles.HC_imgBackground} source={require('../../images/poster1.jpg')} />
          <Image style={styles.HC_iconBack} source={require('../../images/backArrow.png')} />
          ...
          <LinearGradient
            ...
            <Pressable style={styles.HC_btnGetTicket}>
              <Image style={styles.HC_iconTicket} source={require('../../images/ticket.png')} />
        ...
        <View style={styles.InformationContainer}>
          <View style={styles.IC_listNote}>
            <View style={styles.IC_listContainer}>
              ...
              <Text style={styles.IC_itemListNote}>Action</Text>
              <Text style={styles.IC_itemListNote}>2 Trailers</Text>
            </View>
            <View style={styles.IC_timeContainer}>
              <Image style={styles.IC_iconTime} source={require('../../images/Clock.png')} />
              <Text style={styles.IC_textTime}>2h 13m</Text>
            </View>
          </View>
          <Text style={styles.TextName}>Spider-Man: No Way Home </Text>
          <Text style={styles.textContent}>With Spider-Man's identity now revealed, our friendly
          ...
          <View style={styles.moreInfor}>
            ...
            <View style={styles.row}>
              ...
              <Text style={styles.textParticle}>Robert Pattinson,
                Zoë Kravitz, Jeffrey Wright, Colin Farrell, Paul Dano,
                John Turturro, 	Andy Serkis, Peter Sarsgaard</Text>
            </View>
          </View>
        </View>
