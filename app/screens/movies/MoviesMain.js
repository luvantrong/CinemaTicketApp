import { ScrollView, StyleSheet, Text, View, Image, useWindowDimensions, Dimensions, Pressable } from 'react-native'
                        ...
                        return (
                            <View style={{ width: SIZE, }} key={index} >
                                <Animated.View style={[styles.imageContainer, style]}>
                                    <Image style={styles.imageItem} source={item.image} key={item._id} />
                                </Animated.View>
                            </View>
                        )
                    })
