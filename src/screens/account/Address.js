...
const Address = props => {
  ...
  const [listData, setListData] = useState([
    {id: 0, nameCard: 'Home', numberCard: 'Lungangen 6, 41722'},
    {id: 1, nameCard: 'Office', numberCard: 'Lungangen 6, 41722'},
  ]);
  ...
  const renderItem = data => (
    <TouchableHighlight style={styles.rowFront}>
      <TouchableOpacity style={styles.container2} onPress={goEditAddress}>
        <View style={styles.view1}>
          <Image
            style={{marginEnd: 20}}
            source={require('../../images/homeAdress.png')}
          />
